...
a[d]["class"]?j=a[d]["class"]:d==a.length-1&&2>=a.length&&(j="btn-primary");g=a[d].label?a[d].label:"Option "+(d+1);a[d].icon&&(k="<i class='"+a[d].icon+"'></i> ");f+="<a data-handler='"+d+"' class='btn "+j+"' href='#'>"+k+""+g+"</a>";h[d]=l}c.modal_class||(c.modal_class="");a=["<div class='bootbox modal "+c.modal_class+"'>"];if(c.header){d="";if("undefined"==typeof c.headerCloseButton||c.headerCloseButton)d="<a href='#' class='close'>&times;</a>";a.push("<div class='modal-header'>"+d+"<h3>"+c.header+
"</h3></div>")}a.push("<div class='modal-body'></div>");f&&a.push("<div class='modal-footer'>"+f+"</div>");a.push("</div>");var i=$(a.join("\n"));("undefined"===typeof c.animate?o:c.animate)&&i.addClass("fade");$(".modal-body",i).html(b);$.isPlainObject(b)&&($.isFunction(b.promise)&&$.isFunction(b.done))&&(c.show=!1,b.done(function(){i.modal("show")}));c.remove_when_hidden&&i.bind("hidden",function(){i.remove()});i.bind("hide",function(){if(e=="escape"&&typeof c.onEscape=="function")c.onEscape()});
$(document).bind("keyup.modal",function(a){a.which==27&&(e="escape")});i.bind("shown",function(){$("a.btn-primary:last",i).focus()});i.on("click",".modal-footer a, a.close",function(a){var b=$(this).data("handler"),b=h[b],c=null;typeof b=="function"&&(c=b(a));if(c!==false){a.preventDefault();e="button";i.modal("hide")}});null==c.keyboard&&(c.keyboard="function"==typeof c.onEscape);$("body").append(i);i.modal({backdrop:c.backdrop||!0,keyboard:c.keyboard,show:c.show});return i};f.hideAll=function(){$(".bootbox").modal("hide")};
f.animate=function(b){o=b};return f}();
